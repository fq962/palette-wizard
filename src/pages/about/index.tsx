      ...
      <main>
        ...
        <div className="flex flex-col xl:flex-row gap-2">
          <p className="text-lg font-sf-display text-balance opacity-80 leading-relaxed mb-6">
            ...
            , who wanted to create a unique tool inspired by the simplicity and
            creativity of platforms like{" "}
            <a
              target="_blank"
            ...
            . Their vision was to craft something that could seamlessly generate{" "}
        ...
        <p className="text-lg font-sf-display opacity-80 leading-relaxed mb-6">
          ...
          <strong className="font-sf-display-bold">OpenAI&apos;s GPT-4</strong>,
          leveraging its advanced AI capabilities to craft palettes that are not
          only{" "}
        ...
        <p className="text-lg font-sf-display opacity-80 leading-relaxed mb-6">
          ...
          design philosophy is inspired by the meticulous attention to detail of
          companies like <strong className="font-sf-display-bold">Apple</strong>{" "}
          and other industry leaders who create <em>intuitive</em> and{" "}
          <em>aesthetically pleasing</em> user experiences. We set out to build
          a tool that not only works seamlessly but also feels{" "}
        ...
        <p className="text-lg font-sf-display opacity-80 leading-relaxed">
          ...
          something we&apos;re truly proud of—and we&apos;re excited to share it
          with you.
        </p>
      </main>
    </Hero>
